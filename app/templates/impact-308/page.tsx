      ...
      <section id="about" style={{ padding: '120px 24px', background: C.bg }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <Reveal delay={0.15}>
                <Eyebrow>Re-Thread Studio</Eyebrow>
                <h2 style={{
                  fontFamily: SERIF,
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                  ...
                  <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
                    ...
                    <div>
                      ...
                      <a href="mailto:contact@mysite.com" style={{ fontSize: 15, color: C.text, fontWeight: 700, textDecoration: 'none' }}>contact@re-threadstudio.com</a>
                    </div>
                  </div>
