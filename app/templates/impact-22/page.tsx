...
import { Menu, X, ArrowRight, Cloud, Cpu, Zap, Database, Lock, BarChart3, ChevronDown, CheckCircle, GitBranch, Globe } from "lucide-react";
      ...
      <nav className="fixed top-4 left-4 right-4 z-50">
        <div className="max-w-6xl mx-auto bg-[#060B16]/90 backdrop-blur-md border border-white/10 rounded-2xl px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button className="bg-gradient-to-r from-[#06B6D4] to-[#8B5CF6] text-white text-sm px-5 py-2.5 rounded-xl hover:opacity-90 transition-opacity cursor-pointer font-medium">Démarrer</button>
          </div>
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto w-full relative z-10 text-center">
          ...
          <Reveal delay={0.3} className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-gradient-to-r from-[#06B6D4] to-[#8B5CF6] text-white font-bold px-8 py-4 rounded-xl hover:opacity-90 transition-opacity cursor-pointer flex items-center justify-center gap-2">
              Commencer gratuitement <ArrowRight className="w-4 h-4" />
            </button>
            <button className="border border-white/10 text-white px-8 py-4 rounded-xl hover:bg-white/5 transition-colors cursor-pointer flex items-center justify-center gap-2">
            ...
            {models.map((m, i) => (
              <Reveal key={m.name} delay={i * 0.06}>
                <div className="bg-[#0D1525] border border-white/5 rounded-2xl p-5 flex items-center justify-between hover:border-[#06B6D4]/20 transition-colors cursor-pointer group">
                  ...
                  <button className="text-xs text-gray-500 group-hover:text-[#06B6D4] transition-colors cursor-pointer ml-4">Utiliser →</button>
                </div>
              </Reveal>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <Reveal>
            <div className="relative bg-gradient-to-br from-[#06B6D4]/10 to-[#8B5CF6]/10 border border-[#06B6D4]/20 rounded-3xl p-10 md:p-16">
              ...
              <button className="bg-gradient-to-r from-[#06B6D4] to-[#8B5CF6] text-white font-bold px-10 py-4 rounded-xl hover:opacity-90 transition-opacity cursor-pointer text-lg">
