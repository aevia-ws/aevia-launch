         ...
         <div className="hidden md:flex gap-10 text-[10px] font-black uppercase tracking-widest text-white/40">
            {[
              ...
              <Link 
                key={item.key} 
                href={item.path} 
                className={`hover:text-white transition-colors ${item.key === "legal" ? "text-blue-500 font-extrabold" : ""}`}
              >
                [ {item.name.replace(" ", "_")} ]
              </Link>
            ))}
                  ...
                  <div className="flex flex-col gap-8 mt-16 text-left font-mono">
                     {[
                       ...
                       <Link 
                         key={item.key} 
                         href={item.path} 
                         className={`text-xl font-black uppercase tracking-widest hover:text-blue-500 transition-colors ${item.key === "legal" ? "text-blue-500" : "text-white/60"}`}
                       >
                         {item.name.replace(" ", "_")}
                       </Link>
                     ))}
