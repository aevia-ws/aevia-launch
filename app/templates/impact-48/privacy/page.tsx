    ...
    <div>
      ...
      <section style={{ background: C.bg, padding: '90px 40px 120px' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <p style={para}>
            Le responsable du traitement des données personnelles est <span style={strong}>Valentin Milliand</span>. Pour toute question, écrivez à <span style={strong}>contact@aevia.io</span>.
          </p>
