                 ...
                 <div>
                    <Reveal>
                       <div className="mb-24 text-left">
                          ...
                          <h2 className="text-7xl md:text-[10vw] font-black tracking-tighter uppercase text-white italic leading-none text-white">Pure_Quantum.</h2>
                       </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-32 mb-60 text-white">
              <div className="lg:col-span-2">
                 ...
                 <div className="flex gap-16">
                    {["PulseLog", "QuantumRegistry", "GitHub", "X_Protocol"].map(s => (
              ...
              {[
                { t: "PROCESSORS", l: ["Quantum-v4 Pulse", "Qubit Grid v5", "Entangle Link Alpha", "Axiom-Q"] },
                { t: "TECHNOLOGY", l: ["Cryo Cooling", "Gate Logic", "Quantum Sync", "SLA Reports"] },
                { t: "ATELIER", l: ["Our Legacy", "Quantum Ethics", "Locations", "Support"] }
              ].map((col, i) => (
    ...
    <div className="fixed inset-0 pointer-events-none z-[100]">
       ...
       <div className="absolute top-12 left-1/2 -translate-x-1/2 flex items-center gap-20 bg-black/60 backdrop-blur-2xl px-12 py-4 border border-white/10 rounded-none">
          <div className="flex items-center gap-6 text-white">
             <div className={`w-3 h-3 transition-colors duration-500 ${isCoherenceStable ? "bg-purple-400 animate-pulse" : "bg-red-500 animate-ping"}`} />
             <span className="text-[10px] font-black uppercase tracking-[0.4em] italic leading-none">Pulse_Sync: {isCoherenceStable ? "NOMINAL" : "QUANTUM_DISRUPTION"} // Status: ACTIVE</span>
          </div>
