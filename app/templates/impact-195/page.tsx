        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <div className="hidden lg:flex gap-9 text-[10px] font-bold uppercase tracking-[0.22em] text-[#1a1018]/28">
            {["Formules", "Portfolio", "L'équipe", "Blog", "Contact"].map(l => (
              <Link key={l} href="#" className="hover:text-[#c4a06a] transition-colors">{l}</Link>
            ))}
          </div>
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="bg-[#fdfaf7] border-slate-100 p-10">
                <div className="flex flex-col gap-7 mt-16">
                  {["Formules", "Portfolio", "Contact"].map(l => <Link key={l} href="#" className="text-3xl font-bold text-[#1a1018] hover:text-[#c4a06a] transition-colors" style={{ fontFamily: "'Lora', serif" }}>{l}</Link>)}
          ...
          {[
            ...
            <div key={i}>
              ...
              <ul className="space-y-2.5">
                {col.ls.map(l => <li key={l}><Link href="#" className="text-[#fdfaf7]/15 text-sm hover:text-[#fdfaf7]/50 transition-colors">{l}</Link></li>)}
              </ul>
            </div>
          ))}
        </div>
