...
export default function Page() {
  return (
    <div className="bg-[#020a13] min-h-screen text-[#f4f4f4] font-sans selection:bg-white/10">
      {/* Header */}
      ...
      <main className="max-w-4xl mx-auto px-6 pt-36 pb-24">
        <h1 className="text-3xl md:text-5xl font-serif mb-6 text-[#c5a059]">Conditions Générales d'Utilisation</h1>
