        ...
        <Reveal>
          ...
          <div className="space-y-10 text-xs font-bold uppercase tracking-widest text-white/40 leading-relaxed">
            <section className="space-y-4">
              ...
              <p>
                Physical Address: Valentin Milliand, SIREN 852 546 225, RCS Bourg-en-Bresse (physical address provided upon simple request at <a href="mailto:valentinmilliand@aevia.services" className="text-stone-400 hover:underline">valentinmilliand@aevia.services</a>).
              </p>
              <p>
            ...
            <section className="space-y-4">
              ...
              <p>
                For any inquiry regarding this service, please contact us at: <a href="mailto:valentinmilliand@aevia.services" className="text-stone-400 hover:underline">valentinmilliand@aevia.services</a>
              </p>
            </section>
